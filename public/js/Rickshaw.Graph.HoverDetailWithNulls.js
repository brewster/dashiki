Rickshaw.namespace('Rickshaw.Graph.HoverDetailWithNulls');

Rickshaw.Graph.HoverDetailWithNulls = Rickshaw.Class.create({
	...
	initialize: function(args) {
		...
		this.yFormatter = args.yFormatter || function(y) {
                  return typeof(y) == 'number' ? y.toFixed(2) : typeof(y);
		};
