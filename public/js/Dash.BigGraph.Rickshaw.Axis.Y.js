// hacked version of y-axis: constructor returns this so we can store the object;
// configure() lets us change properties of object after creation

Dash.namespace('Dash.BigGraph.Rickshaw.Axis.Y');

Dash.BigGraph.Rickshaw.Axis.Y = function(args) {
  ...
  // allow us to reconfigure axis properties any time
  ...
  this.render = function() {
    ...
    axis.tickFormat(this.tickFormat || function(y) { return y }); // use configured property instead of enclosed var
